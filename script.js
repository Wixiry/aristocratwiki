...

    {
        ...
        content: `
            ...
            <div class="wiki-block-success">
                <strong>❗ Что такое работа с контрактами? Это выполнение различных задач и поручений от руководства семьи.
            </div>
...
<div class="wiki-block-cyber">
    <div class="cyber-list">
        ...
        <p>Вступая в Aristocrat и выбирая контрактную деятельность, ты получаешь не просто слова, а реальные обязательства от семьи. Мы ценим твое время и усилия. Вся информация о доступных контрактах, условиях и выплатах ждет тебя в нашем разделе. Приходи и выбирай задание по душе.</p>
