const articles = [
    {
        ...
        content: `
            ...
            <p>
Поддержка 24/7: Мы всегда на связи и готовы ответить на твои вопросы по механике госструктур.
Карьерный рост: Поможем устроиться на работу, подскажем, как продвигаться по службе и получать больше возможностей.
Участие в жизни города: Вместе мы будем участвовать в рейдах, мероприятиях и строить будущее Нью-Йорка.
