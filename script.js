const articles = [
    {
        ...
        content: `
            ...
            <p>Поддержка 24/7: Мы всегда на связи и готовы ответить на твои вопросы по механике госструктур.<br>
Карьерный рост: Поможем устроиться на работу, подскажем, как продвигаться по службе и получать больше возможностей.<br>
Участие в жизни города: Вместе мы будем участвовать в рейдах, мероприятиях и строить будущее Нью-Йорка.<br>
Дружеское комьюнити: У нас нет места токсичности. Мы начинающая семья, и каждый новый участник для нас — ценный друг.
</p>
